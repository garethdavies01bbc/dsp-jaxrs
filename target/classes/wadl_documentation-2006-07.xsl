...
>
            ...
            <head>
                <title>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>Olympics Data API </xsl:otherwise>
                    </xsl:choose>                 
                </title>
                <style type="text/css">
                    body {
            ...
            <body>
                <h1>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>WADL Documentation</xsl:otherwise>
                    </xsl:choose>
                </h1>
    ...
    <xsl:template match="wadl:param">
        <tr>
            ...
            <td>
                ...
                <xsl:if test="@repeating='true'">Repeating</xsl:if>
            </td>
            <td>
                <xsl:apply-templates select="wadl:doc"/>
                <xsl:if test="@path"><p>XPath to value: <tt><xsl:value-of select="@path"/></tt></p></xsl:if>
            </td>
        </tr>                
    </xsl:template>
    ...
    <xsl:template match="wadl:option">
        <li>
            ...
            <xsl:if test="ancestor::wadl:param[1]/@default=@value"> <td> (default)</td></xsl:if>
